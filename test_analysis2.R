...
# Source global.R using absolute path
source("C:/Users/Admin/OneDrive - Mascot Universal Pvt Ltd/Documents/Claude/Projects/Project_QA/qa_reviewer/global.R")
...
# Run the audit
cat("Running audit with model:", model, "\n")
result <- run_audit(
  text = text,
  model = model,
  config = APP_CONFIG,
